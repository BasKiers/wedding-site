...
CREATE TABLE "new_RSVPPerson" (
    ...
    "dinnerKind" BOOLEAN NOT NULL DEFAULT false,
    "dinnerStarter" TEXT,
    "dinnerMain" TEXT,
    "dinnerDesert" TEXT,
...
INSERT INTO "new_RSVPPerson" ("createdAt", "dietAlt", "dietAltText", "dietFish", "dietMeat", "dinnerDesert", "dinnerMain", "dinnerStarter", "id", "name", "remark", "rsvpCeremony", "rsvpDinner", "rsvpParty", "rsvpReception", "submissionId", "updatedAt") SELECT "createdAt", "dietAlt", "dietAltText", "dietFish", "dietMeat", "dinnerDesert", "dinnerMain", "dinnerStarter", "id", "name", "remark", "rsvpCeremony", "rsvpDinner", "rsvpParty", "rsvpReception", "submissionId", "updatedAt" FROM "RSVPPerson";
